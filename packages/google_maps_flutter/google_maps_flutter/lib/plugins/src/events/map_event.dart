...
/// An event fired when a [Heatmap] is tapped.
class HeatmapTapEvent extends MapEvent<HeatmapId> {
  /// Build an HeatmapTap Event triggered from the map represented by `mapId`.
  ///
  /// The `value` of this event is a [HeatmapId] object that represents the tapped Heatmap.
  HeatmapTapEvent(int mapId, HeatmapId heatmapId) : super(mapId, heatmapId);
}
