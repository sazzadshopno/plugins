...
void main() {
  ...
  late final FakePlatformViewsController fakePlatformViewsController =
  ...
  testWidgets('Initializing a heatmap', (WidgetTester tester) async {
    ...
    late final FakePlatformGoogleMap platformGoogleMap =
        fakePlatformViewsController.lastCreatedView!;
    expect(platformGoogleMap.heatmapsToAdd.length, 1);

    late final Heatmap initializedHeatmap =
        platformGoogleMap.heatmapsToAdd.first;
